...
*/
//cacheFunction debe recordar los resultados de las operaciones.
//const cacheFunction = cb => (arg) => cache[arg] ? cache[arg] : cache[arg] = cb(arg);
let obj= {}
return function(arg){
...
let textoUnderscore = crearCadena.bind(undefined,"_","_","Hola")
